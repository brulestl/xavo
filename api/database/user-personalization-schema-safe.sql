-- User Personalization Schema (Safe Version)
...
CREATE OR REPLACE FUNCTION fn_insert_or_update_personalization(
  p_user_id UUID,
...
CREATE OR REPLACE FUNCTION fn_calculate_personality_scores(
  p_user_id UUID
)
RETURNS JSONB
LANGUAGE plpgsql
