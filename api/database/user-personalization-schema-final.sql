-- User Personalization Schema (Final Safe Version)
-- This file contains the user_personalization table and related functions
-- Safe to run multiple times - drops existing policies AND functions first
...
-- Drop existing functions if they exist (safe to run multiple times)
