 ...
 */
export function buildCoachPrompt(options: CoachPromptOptions): string {
  const {
    tier,
    userPersonalization = {},
    personalityScores = {},
 ...
 */
function getBasicCoachPrompt(tier: string): string {
 ...
 */
export function getToneForPersona(persona: string): {
  tone: string;
  depth: string;
  typicalGoals: string[];
} {
 ...
 */
export function buildUserContextString(userPersonalization: UserPersonalization): string {
