...
export class EnhancedRAGService {
  ...
  async enhanceRequestWithRAG(
    ...
    try {
      // Get memory context (existing functionality)
  ...
  private getSystemContext(actionType?: string): string {
    const baseContext = `You are Xavo, a Corporate Influence Coach specialized in helping professionals navigate workplace dynamics, office politics, and corporate communication. You provide strategic advice on stakeholder management, influence building, and professional relationship development.`;
