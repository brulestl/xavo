...
export type ToasterContextType = Required<Pick<ToasterProps, 'duration' | 'swipToDismissDirection' | 'closeButton' | 'position' | 'unstyled' | 'invert' | 'styles' | 'classNames' | 'icons' | 'offset' | 'pauseWhenPageIsHidden' | 'cn' | 'gap'>> & {
